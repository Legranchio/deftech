{* 
	...
	<span data-uf-open="/engine/ajax/uniform/uniform.php" data-uf-settings='{"formConfig": "callbackop"}' class="uf-btn">Связаться с оператором</span> 
*}
<div class="uf-wrapper">
	...
	[/error]
	[success]
		<div class="uf-content"><b>Ваша заявка принята!</b> <br> Ждите звонка оператора в удобное для вас время.</div>
	[/success]
	[form]
